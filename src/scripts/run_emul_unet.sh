...
# $1 = configs/config_command_emul_unet_delta.yaml ou config_command_emul_unet_state.yaml
CONFIG=${1:-configs/config_command_emul_unet_delta.yaml}

python entrypoints/main_emul_unet.py "$CONFIG"
