...
class EmulatorUNet(unet_2D.UNet2D):

    def __init__(self, input_dim, output_dim, depth=3, base_width=32, tau=1e-5, device="cpu"):

        super().__init__(input_dim, output_dim, depth, base_width, device=device)
...
class UNetTraining():
    ...
    def __init__(self, args):
        ...
        self.depth = self.args.get("depth", 3)
        self.base_width = self.args.get("base_width", 32)
    ...
    def execute_experience(self):
        ...
        model = EmulatorUNet(input_dim=self.input_dim,
